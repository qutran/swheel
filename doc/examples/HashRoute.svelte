<script>
  import { MemoryRouter, Route, HashRoute } from '../../src/Router';
  ...
  <Example title="HashRoute">
    ...
    <div slot="content">
      ...
      <Route path="/page2" exact>
        <Page2 />
        <HashRoute hash="#hash" let:removeHash>
          <div>Hash Item</div>
          <button on:click={removeHash}>Remove hash</button>
        </HashRoute>
      </Route>
    </div>
  </Example>
